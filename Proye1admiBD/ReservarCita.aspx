<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.Master" CodeBehind="ReservarCita.aspx.vb" Inherits="Proye1admiBD.Formulario_web17" %>
            ...
            <div class="col-8">
                <div class="form-control card card-body">
                    ...
                    <div class="row">
                        ...
                        <asp:Button ID="Button10" runat="server" Text="Reservar Cita" CssClass=" form-control btn btn-primary " BackColor="#E9ECEF" BorderStyle="None" ForeColor="Gray" />
                        <hr />
                        ...
                        <hr />--%>
                        <asp:Button ID="Button12" runat="server" Text="Cancelar" BorderStyle="None" ForeColor="Gray" CssClass=" form-control btn btn-primary " BackColor="#E9ECEF" />
                        <hr />
                    </div>
