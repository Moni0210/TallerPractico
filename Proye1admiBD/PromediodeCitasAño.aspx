<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.Master" CodeBehind="PromediodeCitasAño.aspx.vb" Inherits="Proye1admiBD.Formulario_web119" %>
                ...
                <fieldset>
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control">
                            <asp:ListItem Value="0">Citas Canceladas</asp:ListItem>
                            <asp:ListItem Value="1">Citas efectivas</asp:ListItem>
                    ...
                    <div class="input-group">
                        <asp:Label ID="Label2" CssClass="form-control" runat="server" Text="Fecha del informe:"></asp:Label>
